...
function App() {
  ...
  var StateStatusClass = location.includes("/StateStatus") ? "nav-item active" : "nav-item";
  var issuesBoardClass = location.includes("/issuesBoard") ? "nav-item active" : "nav-item";
  var issuesBoardClass = location.includes("/issuesDetails") ? "nav-item active" : "nav-item";

  return (
    <Router>
      <div className="container" style={{ 'max-width': '1600px' }}>
        <br />
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              {/* <li class={StateStatusClass}><a class="nav-link" href="/StateStatus">CHECK STATUS OF ISSUE</a></li> */}
              <li class={issuesBoardClass}><a class="nav-link" href="/issuesBoard">ISSUE'S  BOARD</a></li>
            </ul>
          </div>
        </nav>
        <br />
        <Switch>
          ...
          <Route exact path='/StateStatus' component={StateStatus} />
          <Route exact path='/issuesBoard' component={IssuesBoard} />
          <Route exact path='/issuesDetails' component={IssueDetails} />
        </Switch>
      </div>
    </Router >
  );
