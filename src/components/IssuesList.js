...
class IssuesList extends React.Component {
    ...
    async getIssuesListData() {
        var result = [];
        var issuesFetched = localStorage.getItem("issuesList");
        if(issuesFetched != null){
            result = localStorage.getItem("issuesList");
        }
        console.log(result)
        this.setState({ loading: false, issues: result });
    }
    ...
    syncTable() {
        ...
        this.$el.DataTable({
            ...
            columns: [
                { title: "STATUS", data: "severity" },
                { title: "ISSUE OCCURED DATE", data: "issueOccuredDate" },
                { title: "ISSUE TYPE", data: "issueCategory" },
                { title: "DESCRIPTION", data: "description" },
                { title: "STEP'S TO REPRODUCE ISSUE", data: "reproduceIssue" },
                { title: "ACTION", data: "" }
            ],
